...
sablono.util.ToString = (function (){var obj9271 = {};return obj9271;
})();
...
sablono.util.ToURI = (function (){var obj9273 = {};return obj9273;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__9274){
var xs = cljs.core.seq(arglist__9274);
...
{var vec__9276 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__9276,(0),null);var words = cljs.core.nthnext.call(null,vec__9276,(1));if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
{var ks = cljs.core.keys.call(null,m);var kmap = cljs.core.zipmap.call(null,ks,cljs.core.map.call(null,sablono.util.camel_case,ks));var G__9278 = clojure.set.rename_keys.call(null,m,kmap);var G__9278__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__9278,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),camel_case_keys):G__9278);return G__9278__$1;
} else
{return m;
}
});
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__9279_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__9279_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__9279_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_.call(null,p1__9279_SHARP_))
{return p1__9279_SHARP_;
} else
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__9279_SHARP_], null);
...
merge_with_class.cljs$lang$applyTo = (function (arglist__9280){
...
* CSS classes.
*/
sablono.util.match_tag = (function match_tag(s){var matches = cljs.core.re_seq.call(null,/[#.]?[^#.]+/,cljs.core.name.call(null,s));var vec__9284 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,("Can't match CSS tag: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));var tag_name = cljs.core.nth.call(null,vec__9284,(0),null);var names = cljs.core.nth.call(null,vec__9284,(1),null);return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__9284,tag_name,names){
return (function (p1__9281_SHARP_){return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__9281_SHARP_));
});})(matches,vec__9284,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__9284,tag_name,names){
return (function (p1__9282_SHARP_){return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__9282_SHARP_));
});})(matches,vec__9284,tag_name,names))
,names)))], null);
});
/**
...
*/
sablono.util.normalize_element = (function normalize_element(p__9285){var vec__9288 = p__9285;var tag = cljs.core.nth.call(null,vec__9288,(0),null);var content = cljs.core.nthnext.call(null,vec__9288,(1));if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__9289 = sablono.util.match_tag.call(null,tag);var tag__$1 = cljs.core.nth.call(null,vec__9289,(0),null);var id = cljs.core.nth.call(null,vec__9289,(1),null);var class$ = cljs.core.nth.call(null,vec__9289,(2),null);var tag_attrs = sablono.util.compact_map.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"class","class",-2030961996),class$], null));var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
